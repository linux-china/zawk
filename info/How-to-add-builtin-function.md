...
* Add function name in `fn arity(`(参数个数) function of [src/builtins.rs](../src/builtins.rs)
...
* Add function name in `fn accum(&self`(累加器) of [src/bytecode.rs](../src/bytecode.rs)
